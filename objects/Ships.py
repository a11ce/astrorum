...
class Ship:
    def __init__(self, name=None, cargo=None, crew=None, cargoCap=100, crewCap=6, roomCap=7):
        self.name = name
        self.cargo = cargo
...
class AIShip(Ship):
    def __init__(self, name=None, cargo=None, crew=None, cargoCap=100, crewCap=6, roomCap=7):
        ...
        self.crew = [People.Crew(name = gen.personName(self.lang)) for _ in range(crewCap)]
        self.crewCap = crewCap
